...
| 10.45-11.15 | *Break*                                         |
| 11.15-13.00 | Datatypes *(continued)*                         |
| 13.00-14.00 | *Lunch*                                         |
| 14.00-16.00 | Data manipulation and tidyverse                 |
| *Wednesday* |                                                 |
| 09.00-13.00 | Stratification and allocation                   |  
| 13.00-14.00 | *Lunch*                                         |
| 14.00-16.00 | *(Continued)*                                   |
| *Thursday*  |                                                 |
| 09.00-13.00 | Calibration for non-response                    |  
| 13.00-14.00 | *Lunch*                                         |
| 14.00-16.00 | Making reports                                  |
| *Friday*    |                                                 |
| 09.00-13.00 | Wrapping up                                     |  
| 13.00-14.00 | *Lunch*                                         |
...
- Part D: Data manipulation and tidyverse
    - [Lecture](Contents/Part D - Wrangling/Lecture_D.html){target="_blank"}
    - [Practical 1](Contents/Part D - Wrangling/Practical_D1.html){target="_blank"}
    - [Practical 2](Contents/Part D - Wrangling/Practical_D2.html){target="_blank"}
